                	...
                	<div class="col-lg-12">
                		<div class="panel panel-yellow">
                			<div class="panel-heading">
                				Form Program Penerima Kredit
                			</div>
                			<div class="panel-body">
                				<form action="config/program_bantuan/proses_ubah.php?id=<?php echo $_GET['id'] ?>" method="post">
                					<?php include 'halaman/program_bantuan/form.php'; ?>
